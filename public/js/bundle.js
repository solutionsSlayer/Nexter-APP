...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"account.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePwd = exports.update = void 0;
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"logout.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
const getBook = async homeId => {
  try {
    const session = await (0, _axios.default)(`http://127.0.0.1:3000/api/v1/bookings/checkout-session/${homeId}`);
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"bookings.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"../../node_modules/core-js/modules/_global.js":[function(require,module,exports) {
...
const signBtn = document.querySelector("#signup_btn"); //LOGIN

const loginForm = document.querySelector('.login__form');
const loginBtn = document.querySelector("#login__btn"); //ACCOUNT - USER DATA

const formData = document.querySelector('.form-user-data');
const dataBtn = document.getElementById('dataBtn'); //ACCOUNT - USER PASSWORD

const formPwd = document.querySelector('.form-user-password');
const pwdBtn = document.getElementById('pwdBtn'); //LOG OUT

const btnOut = document.getElementById('log-out'); //STRIPE

const bookBtn = document.getElementById('book-home'); //BOOKING

const closeBtn = document.getElementById('close');

if (sign) {
  signBtn.addEventListener("click", async e => {
    e.preventDefault(); // ANIMATION
...
if (loginForm) {
  loginBtn.addEventListener("click", async e => {
    ...
    loginBtn.textContent = "CONNEXION ..."; // LOGIN DATA
...
if (formData) {
  dataBtn.addEventListener('click', async e => {
    ...
    dataBtn.textContent = "Updating ..."; // UPDATED DATA

    const form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    await (0, _account.update)(form);
...
if (formPwd) {
  pwdBtn.addEventListener('click', async e => {
    ...
    pwdBtn.textContent = "Updating ..."; // UPDATED DATA
    ...
    await (0, _account.updatePwd)(passwordCurr, password, passwordConf);
...
if (closeBtn) {
  closeBtn.addEventListener('click', e => {
    ...
    (0, _bookings.deleteBook)(homeId);
  });
}
},{"./signup":"signup.js","./login":"login.js","./account":"account.js","./logout":"logout.js","./stripe":"stripe.js","./bookings":"bookings.js","babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
